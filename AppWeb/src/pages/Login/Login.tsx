    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          {/* Usuário */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, borderBottom: '1.5px solid #d1d5db', paddingBottom: 8 }}>
      ...
      {/* ── Imagem ── */}
      <div style={{ flex: 1, background: '#111827', borderRadius: '16px 0 0 16px', overflow: 'hidden', position: 'relative' }}>
        <img src="/login-warehouse.png" alt="Armazém"
        ...
        <div style={{
          ...
          <p style={{ color: '#f59e0b', fontSize: 13, opacity: 0.6, margin: 0 }}>
